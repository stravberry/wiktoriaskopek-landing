    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden" aria-hidden="true">
         <div className="absolute left-[-20%] md:left-[-10%] top-1/4 -translate-y-1/2 opacity-[0.02] text-white blur-[2px]">
            <Search size="80vw" className="scale-[1.2] md:scale-100" strokeWidth={0.5} />
         </div>
         <div className="absolute right-[-20%] md:right-[-10%] top-3/4 -translate-y-1/2 opacity-[0.02] text-accent blur-[2px]">
            <Zap size="80vw" className="scale-[1.2] md:scale-100" strokeWidth={0.5} />
         </div>
      </div>
      <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-8">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 items-stretch mb-8">
             ...
             <motion.div 
               variants={itemVariants}
               className="relative p-8 md:p-10 rounded-3xl border border-white/[0.04] bg-white/[0.02] flex flex-col"
             >
             ...
             <motion.div 
               variants={itemVariants}
               className="relative p-8 md:p-10 rounded-3xl border border-accent/20 bg-accent/[0.03] flex flex-col shadow-[0_0_40px_rgba(255,102,0,0.05)] overflow-hidden"
             >
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 items-stretch mb-10">
             ...
             <motion.div 
               variants={itemVariants}
               className="relative p-7 rounded-[1.5rem] md:rounded-[2rem] border border-white/[0.08] bg-white/[0.02] overflow-hidden flex flex-col justify-center"
             >
             ...
             <motion.div 
               variants={itemVariants}
               className="relative p-7 rounded-[1.5rem] md:rounded-[2rem] border border-accent/20 bg-accent/[0.03] shadow-[0_0_40px_rgba(255,102,0,0.05)] overflow-hidden flex flex-col justify-center"
             >
                <div className="absolute top-0 right-0 w-40 h-40 bg-accent/10 blur-[60px] pointer-events-none" aria-hidden="true" />
