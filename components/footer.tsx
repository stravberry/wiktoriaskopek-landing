...
export default function Footer({ lang = "pl" }: { lang?: Locale }) {
  ...
  const navLinks = [
    { name: "Strona główna", href: `/${lang}` },
    { name: "Portfolio", href: `/${lang}/portfolio` },
    { name: "Blog", href: `/${lang}/blog` },
    { name: "Studio (podcastkatowice.pl)", href: "https://podcastkatowice.pl", external: true },
    { name: "Kontakt", href: `/${lang}#contact` },
  ]
  ...
  return (
    <footer className="relative bg-[#050505] pt-12 md:pt-16 pb-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
                ...
                <li key={item.name}>
                  {item.external ? (
                    <a
                      ...
                      className="group flex items-center gap-2 font-sans text-sm text-white/30 hover:text-white transition-colors duration-500 font-medium"
                    >
          ...
          <div className="lg:col-span-3">
            ...
            <div className="pt-8 border-t border-white/5 space-y-4">
              <Link
                ...
                className="block font-sans text-[10px] uppercase tracking-widest text-white/20 hover:text-white transition-colors duration-500 font-bold"
              >
        ...
        {/* Brand Imprint Background Decor */}
        ...
        <div className="relative z-10 py-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="font-sans text-[10px] text-white/10 uppercase tracking-widest font-bold">
            Made by Wiktoria Skopek from <a href="https://kodubi.pl" target="_blank" rel="noopener noreferrer" className="hover:text-accent cursor-pointer transition-colors duration-500">Kodubi.pl</a> / <a href="https://webdkw.net" target="_blank" rel="noopener noreferrer" className="hover:text-accent cursor-pointer transition-colors duration-500">Webdkw.net</a>
          </p>
        </div>
      </div>
    </footer>
